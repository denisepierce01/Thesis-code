...
for i = 1:length(folders)
    ...
    if i == 1
        t0 = '2-May-2018 17:00:00';
        tend = '2-May-2018 18:00:00';
    end
...
for k = 1:nTimes
    ...
    for r = 1:3
        ...
        if ~isempty(cx_valid)
            ...
            quiver(ax, x0, y0, u_norm*50, v_norm*50, 0, 'k', 'LineWidth', 1.2, 'MaxHeadSize', 1.1);
        end
    ...
    % Prepare legend handles and labels
    legHandles = [h_groyne, h_groyne_ch, h_groyne_ex, WL_time];
    legLabels = {'New Groyne', 'Modified', 'Existing Groyne', ...
