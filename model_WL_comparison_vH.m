...
%% Load model data
load('P:\11210344-001-bathosszimm\05_Modellering\02_runs\06_bathy_j18_groynes_j18_runperiod_feb18_visc_001\output\DFM.mat');    % visc = 0.01 m2/s
ModelData(1).DFM = DFM;
load('P:\11210344-001-bathosszimm\05_Modellering\02_runs\02_bathy_j18_groynes_j18_runperiod_feb18\output\DFM.mat');             %  visc = 0.1 
ModelData(2).DFM = DFM;
load('P:\11210344-001-bathosszimm\05_Modellering\02_runs\07_bathy_j18_groynes_j18_runperiod_feb18_visc_1\output\DFM.mat');      %  visc = 1 
ModelData(3).DFM = DFM;
load('p:\11210344-001-bathosszimm\05_Modellering\02_runs\12_bathy_j18_groynes_j18_runperiod_feb18_visc_10\output\DFM.mat');     % visc = 10
ModelData(4).DFM = DFM;
...
for ii = 1:nModels
    ...
    fixed_start = datetime('13-02-2018','InputFormat','dd-MM-yyyy');
    fixed_end   = datetime('31-03-2018','InputFormat','dd-MM-yyyy');
